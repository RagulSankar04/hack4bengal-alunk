  ...
  return (
    <div>
      <div>
        ...
        <div
          className="Content1 my-4 p-4 lg:mx-7 lg:text-center my-12"
          id="Content"
        >
          <div className="text-lg text-center  font-bold lg:text-4xl lg:mb-2 lg:mt-6 lg:float-left lg:w-1/2 hover:-translate-y-5 transform transition ">
            SPEND NOW PAY LATER
            <p className="text-sm text-left lg:text-xl text-green-500 lg:w-1/2 lg:my-7 lg:mx-12">
              THE PLATFORM TO HELP YOU BUT THE THINGS YOU ALWAYS WANTED TO, WITH
              THE SPEND NOW PAY LATER FEATURE
            </p>
          </div>
        ...
        <div className="Content2 mx-7  text-center my-12">
          <div className="Heading2 text-lg  text-center font-bold lg:text-4xl lg:mb-2 lg:mt-3 lg:float-right lg:w-1/2 hover:-translate-y-5 transform transition">
            BUDGET MANAGEMENT
            <p className="text-sm text-left lg:text-xl text-green-500 lg:w-1/2 lg:my-7 lg:mx-12">
              A PLATFORM TO HELP YOU HAVE A TRACK ON YOUR EXPENDITURE AND HELP
              YOU SAVE MONEY
            </p>
          </div>
          <Image
        ...
        <div className="Content3 my-4 mx-7 ">
          <div className="text-lg text-center font-bold lg:text-4xl lg:mb-2 lg:mt-3 lg:float-left hover:-translate-y-5 transform transition">
            SPILT & PAY
            <p className="text-sm text-left lg:text-xl text-green-500 lg:w-1/2 lg:my-12 ">
              A PLATFORM WHERE APART FROM DIGITALLY PAYING, YOU CAN ALSO SPILT
              THE BILL
            </p>
          </div>
          <Image
